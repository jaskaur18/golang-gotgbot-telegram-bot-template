...
type User struct {
	...
	Telegramid null.Int64  `boil:"telegramid" json:"telegramid,omitempty" toml:"telegramid" yaml:"telegramid,omitempty"`
	...
	Usertype   Usertype    `boil:"usertype" json:"usertype" toml:"usertype" yaml:"usertype"`
...
type whereHelperUsertype struct{ field string }

func (w whereHelperUsertype) EQ(x Usertype) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperUsertype) NEQ(x Usertype) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperUsertype) LT(x Usertype) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperUsertype) LTE(x Usertype) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperUsertype) GT(x Usertype) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperUsertype) GTE(x Usertype) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperUsertype) IN(slice []Usertype) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
func (w whereHelperUsertype) NIN(slice []Usertype) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var UserWhere = struct {
	...
	Usertype   whereHelperUsertype
	Createdat  whereHelpertime_Time
	Updatedat  whereHelpertime_Time
}{
	ID:         whereHelperstring{field: "\"User\".\"id\""},
	Telegramid: whereHelpernull_Int64{field: "\"User\".\"telegramid\""},
	...
	Language:   whereHelpernull_String{field: "\"User\".\"language\""},
	Usertype:   whereHelperUsertype{field: "\"User\".\"usertype\""},
	Createdat:  whereHelpertime_Time{field: "\"User\".\"createdat\""},
	Updatedat:  whereHelpertime_Time{field: "\"User\".\"updatedat\""},
}
...
var (
	userAllColumns            = []string{"id", "telegramid", "firstname", "lastname", "username", "language", "usertype", "createdat", "updatedat"}
	userColumnsWithoutDefault = []string{"firstname", "lastname"}
	userColumnsWithDefault    = []string{"id", "telegramid", "username", "language", "usertype", "createdat", "updatedat"}
