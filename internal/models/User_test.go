...
var (
	userDBTypes = map[string]string{`ID`: `text`, `Telegramid`: `bigint`, `Firstname`: `text`, `Lastname`: `text`, `Username`: `text`, `Language`: `text`, `Usertype`: `enum.usertype('USER','ADMIN')`, `Createdat`: `timestamp with time zone`, `Updatedat`: `timestamp with time zone`}
	_           = bytes.MinRead
)
